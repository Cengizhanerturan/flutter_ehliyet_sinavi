...
class AboutMotorcyclePageController extends GetxController with StateMixin {
  var list = RxList<AboutMotorcycleModel>();
    ...
    try {
      if (isLazyLoad) {
        if (!noData.value) {
          ...
          var tempList = await _databaseService.getAboutMotorcycle(
        ...
        list.value = await _databaseService.getAboutMotorcycle(
