...
import 'package:flutter_ehliyet_sinavi/view/things_to_know/thing_to_know_details/things_to_know_details_page.dart';
...
class ThingsToKnowPage extends BaseGetView<ThingsToKnowPageController> {
  const ThingsToKnowPage({super.key});
  ...
  Widget _buildCard({required ThingsToKnowModel model}) {
    return InkWell(
      onTap: () {
        Get.to(() => ThingsToKnowDetailsPage(model: model));
      },
      child: Container(
        width: Get.width,
