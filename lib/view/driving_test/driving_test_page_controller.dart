...
class DrivingTestPageController extends GetxController with StateMixin {
  var list = RxList<DrivingTestModel>();
    ...
    try {
      if (isLazyLoad) {
        if (!noData.value) {
          ...
          var tempList = await _databaseService.getDrivingTest(
        ...
        list.value = await _databaseService.getDrivingTest(
