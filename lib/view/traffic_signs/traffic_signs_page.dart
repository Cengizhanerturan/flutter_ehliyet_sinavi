...
import 'package:flutter_ehliyet_sinavi/core/model/traffic_signs.dart';
...
class TrafficSignsPage extends BaseGetView<TrafficSignsPageController> {
  const TrafficSignsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: StringConstants.trafficSigns),
      body: SafeArea(
        child: SizedBox(
          width: Get.width,
          height: Get.height,
          child: controller.obx(
            ...
            onEmpty: const CustomEmptyWidget(
                message:
                    'Şuan için herhangi bir trafik işareti bulunmamaktadır'),
  ...
  Widget _buildCard({required TrafficSignsModel model}) {
    return Container(
      width: Get.width,
