...
import 'package:flutter_ehliyet_sinavi/core/model/trial_exam.dart';
...
class TrialExamPage extends BaseGetView<TrialExamPageController> {
  const TrialExamPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: StringConstants.trialExam),
      body: SafeArea(
        child: SizedBox(
          width: Get.width,
          height: Get.height,
          child: controller.obx(
            ...
            onEmpty: const CustomEmptyWidget(
                message:
                    'Şuan için herhangi bir deneme sınavı bulunmamaktadır'),
