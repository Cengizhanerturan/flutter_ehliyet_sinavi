...
class PreviouslyQuestionsPage
    extends BaseGetView<PreviouslyQuestionsPageController> {
  const PreviouslyQuestionsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: StringConstants.previouslyQuestions),
      body: SafeArea(
        child: SizedBox(
          width: Get.width,
          height: Get.height,
          child: controller.obx(
            ...
            onEmpty: const CustomEmptyWidget(
                message: 'Şuan için herhangi bir çıkmış soru bulunmamaktadır'),
  ...
  Widget _buildCard({
    required PreviouslyQuestionsModel model,
              ...
              children: [
                Image(
                  image: const AssetImage(
                    AssetsConstants.questionMarkIcon,
                  ),
                  fit: BoxFit.cover,
                  width: Get.width * 0.1,
