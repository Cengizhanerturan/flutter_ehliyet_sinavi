...
import 'package:flutter_ehliyet_sinavi/view/topic_explanations/topics/topic_details/topic_details_page.dart';
...
class TopicsPage extends BaseGetView<TopicsPageController> {
  final String topicID;
  final String title;
  const TopicsPage({super.key, required this.topicID, required this.title});

  @override
  String get tag => topicID;
  ...
  Widget _buildCard({required TopicModel model}) {
    return InkWell(
      onTap: () {
        Get.to(() => TopicDetailsPage(
              model: model,
            ));
      },
      child: Container(
